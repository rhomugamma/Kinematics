...
class objectSpecs {
	...
	public:
		...
		float objectVelocityX;
		float objectVelocityY;
		float objectVelocityZ;

		float objectAccelerationX;
		float objectAccelerationY;
		float objectAccelerationZ;
...
int main() {
	...
	std::vector<objectSpecs> ObjectsArray[2];

	ObjectsArray[0] = object1;
	ObjectsArray[1] = object2;
